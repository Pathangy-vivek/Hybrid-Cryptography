...
<form action="ownerlogact.jsp" method="post" >
            ...
            <table>
                <tr>
                    <td align="left"><font size="4" color="black"> User Name: </font></td><td>
...
<br><br><br>    
   ...
   New User <a href="ownerreg.jsp">Click Here</a> To Register</h
                        </center>
          </div>
          <div class="featured_tab"> <img src="img/loginnn.jpg" alt="" />
            <p>Owner--Login</p>
          </div>
        </li>
...
<div id="container">
  <div class="wrapper">
    <div id="content">
      ...
      <p>Owner has to enter valid username and password.Owner Home page will be displayed if login Successfully.</p>
