...
<form action="userlogact.jsp" method="post" >
            ...
            <table>
                <tr>
                    <td align="left"><font size="4" color="black"> Email: </font></td><td>
                        <input type="text" align="left" size="25" name="email"/>
                </tr>
...
<br><br><br>    
   ...
   New User <a href="userreg.jsp">Click Here</a> To Register</h
                        </center>
          </div>
          <div class="featured_tab"> <img src="img/log2.jpg" alt="" />
            <p>User--Login</p>
          </div>
        </li>
  ...
  <div class="wrapper">
    <div id="content">
      <h2>About Login</h2>
       ...
       <p>User has to enter valid username and password.User Home page will be displayed if login Successfully.</p>
      <p>Error message will be displayed if login failed</p>
    </div>
    <div id="column">
      <div class="holder">
        <h2>Know More..!</h2>
