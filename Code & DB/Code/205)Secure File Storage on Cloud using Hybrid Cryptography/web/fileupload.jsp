  ...
  <div class="wrapper">
    <div id="topnav">
      ...
      <li><a href="ownerhome.jsp">Home</a></li>
        <li class="active"><a href="fileupload.jsp">File upload</a></li>
...
<form name="f2" action="Upload" method="post" enctype="multipart/form-data" style="margin-right:  50px">
            ...
            <table>
                <tr>
                    <td align="left"><font size="4" color="black"> File Name: </font></td><td>
                        <input type="text" align="left"  name="fname"/>
                </tr>
               
 <tr>
                    <td align="right"><font size="4" color="black">File Browse</font> </td><td> 
                        <input type="file" align="left" size="25" name="file"/></td>
                </tr>
          ...
          <div class="featured_tab"> <img src="img/download.jpg" alt="" />
            <p>File--Upload</p>
          </div>
        </li>
