  ...
  <div class="wrapper">
    <div id="topnav">
      <ul>
        ...
        <li class="active"><a href="owner.jsp">Owners</a></li>
...
<div id="container">
  <div class="wrapper">
    <div id="content">
     ...
     <form name="myform" method="post" action="ownerregact.jsp">
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        ...
                        <td><input type="text" name="city" id="city" placeholder=city style="height:30px; width:200px"> </input></td>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <td><input type="text" name="contactno" id="contactno1" placeholder= MobileNo. style="height:30px; width:200px"></input>
                            </select></td>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <center>        <td><input type="submit" value="Register" style="height:50px; width:90px" /></td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
                            <td> <input type="reset" value="Reset" style="height:50px; width:90px" /></td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
                    </td>
                </tr>
