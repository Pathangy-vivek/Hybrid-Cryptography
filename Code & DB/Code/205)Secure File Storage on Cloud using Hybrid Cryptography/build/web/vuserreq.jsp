...
if(request.getParameter("msg")!=null){%>
 ...
 <script>alert('Keys Sent Sucessfully to User Mail..!')</script>
 

<%}
if(request.getParameter("m1")!=null){%>

<script>alert('Keys Sending Failed..!')</script>
 <%
}
%>
<body id="top">
    ...
    <div id="topnav">
      <ul>
       ...
       <li><a href="viewencfiles.jsp">View Split Data</a></li>
        <li class="active"><a href="vuserreq.jsp">View Request</a></li>
...
      
<%--       <th><font color="red">Data</font></th> --%>
        <th><font color="red">Owner</font></th>
          <th><font color="red">User</font></th>
...
<%
  ...
  <%--               <th><%=rs.getString(2)%></th>   --%>
               ...
               <th><a href="response.jsp?filename=<%=rs.getString(1)%>&data=<%=rs.getString("data")%>&owner=<%=rs.getString("owner")%>&email=<%=rs.getString("email")%>" >Send Key</a></th> 
