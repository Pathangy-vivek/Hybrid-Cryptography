...
<div id="topbar">
  <div class="wrapper">
    <div id="topnav">
     ...
     <li><a href="dload.jsp">Download</a></li>
...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
                   <%
                    ...
                    %>
                    <center> 
                        <h2> Part-1 Key Verification System</h2>
                            <form action="verify1.jsp" method="post">
                                <label>File Name  :</label><input type="text" name="filename" value="<%=filename%>"  style="margin-left: 30px" class="textbox"/><br /><br />
                                <label>Part1 Key :</label><input type="text" name="dkey" required="" class="textbox"/><br /><br />
